              ...
              <div class="flex items-center gap-3 mt-1 flex-wrap">
                ...
                <template v-if="course.expectedCohortsPerYear && Object.keys(course.expectedCohortsPerYear).length > 0">
                  ...
                  <div class="flex items-center gap-1 flex-wrap">
                    <span
                      v-for="(count, year) in course.expectedCohortsPerYear"
                      :key="year"
            ...
            <div v-else class="space-y-2">
              ...
              >
                ...
                <div class="flex items-center gap-2">
                  ...
                  <button
                    @click="handleDeleteDiscipline(subject.id, course)"
                    class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition"
                  >
                    <Trash2 class="w-4 h-4" />
                  </button>
      ...
      <div class="bg-white rounded-lg shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form @submit.prevent="handleCourseSubmit" class="p-6 space-y-5">
          ...
          <div>
            ...
            <div class="relative">
              <select
                v-model.number="courseForm.coordinatorId"
                required
          ...
          <div>
            ...
            <input
              v-model.number="courseForm.years"
              type="number"
              min="1"
              max="6"
              required
          ...
          <div>
            ...
            <div class="border border-gray-200 rounded-lg overflow-hidden">
              ...
              >
                ...
                <div class="flex items-center gap-2">
                  <button
                    type="button"
                    @click="row.count = Math.max(0, row.count - 1)"
            ...
            <p class="text-xs text-gray-400 mt-1.5">
              Define quantas turmas são esperadas por semestre para cada ano curricular. Usado na estimativa de geração de horários.
            </p>
          </div>
        ...
        <div class="p-6 space-y-4">
          ...
          <div>
            ...
            <div class="border border-gray-300 rounded-lg max-h-48 overflow-y-auto">
              ...
              <div v-else-if="filteredTeachers.length === 0" class="p-4 text-center text-gray-400 text-sm">Nenhum professor encontrado</div>
              <div v-else>
                <button
